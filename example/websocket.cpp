...
namespace websocketpp {
    typedef lib::weak_ptr<void> connection_hdl;  // websocket连接句柄
    ...
    class endpoint : public config::socket_type {
        ...
        void set_access_channels(log::alevel channels);   /* 设置⽇志打印等级 */
        void clear_access_channels(log::alevel channels); /* 清除指定等级的⽇志 */
